...
+-------------+----------------+-------+-----------+-------------+----------------+----------------------------------------------+
| normative_  | review-status_ | SME_  | evidence_ | reference_  | suspect-links_ | score_                                       |
+=============+================+=======+===========+=============+================+==============================================+
| ``false``   | ``*``          | ``*`` | ``*``     | ``*``       | ``*``          | no score                                     |
+-------------+----------------+-------+-----------+-------------+----------------+----------------------------------------------+
| ``true``    | ``false``      | ``*`` | ``*``     | ``*``       | ``*``          | 0.0                                          |
...
+-------------+----------------+-------+-----------+-------------+----------------+----------------------------------------------+
| ``true``    | ``true``       | ``*`` | ``*``     | ``*``       | ``yes``        | mean of child items with no suspect links    |
+-------------+----------------+-------+-----------+-------------+----------------+----------------------------------------------+
...
.. _suspect-links: https://codethinklabs.gitlab.io/trustable/trustable/reference/trudag/dotstop/core/graph/trustable_graph.html#trudag.dotstop.core.graph.trustable_graph.LinkStatus
...
- **suspect-links**: Indicates whether there are any suspect links between child and parent items. If suspect links exist, the score is calculated based on child items without suspect links only.   
